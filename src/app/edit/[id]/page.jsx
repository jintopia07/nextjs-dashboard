    ...
    <Container>
        ...
        <div className='flex-grow'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type='text' className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder={postData.post?.img} onChange={(e) => setNewImg(e.target.value)} value={newImg}></input>
                <textarea className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' name='' id='' cols="30" rows="10" placeholder={postData.post?.content} onChange={(e) => setNewContent(e.target.value)} value={newContent}>
